...
int
encode_HDB_extensions(unsigned char *p, size_t len, const HDB_extensions *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
decode_HDB_extensions(const unsigned char *p, size_t len, HDB_extensions *data, size_t *size)
{
size_t ret = 0;
size_t l;
int e;
