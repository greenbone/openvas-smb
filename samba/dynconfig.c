...
_PUBLIC_ const char *dyn_BINDIR = ".";

/**< Location of smb.conf file. **/
_PUBLIC_ const char *dyn_CONFIGFILE = "."; 

/** Log file directory. **/
_PUBLIC_ const char *dyn_LOGFILEBASE = "."; 

/** Directory for local RPC (ncalrpc: transport) */
_PUBLIC_ const char *dyn_NCALRPCDIR = ".";

/** Statically configured LanMan hosts. **/
_PUBLIC_ const char *dyn_LMHOSTSFILE = "."; 

/** Samba data directory. */
_PUBLIC_ const char *dyn_DATADIR = ".";

_PUBLIC_ const char *dyn_MODULESDIR = ".";
...
/** pid file directory */
_PUBLIC_ const char *dyn_PIDDIR  = ".";

/** Private data directory; holds ldb files and the like */
_PUBLIC_ const char *dyn_PRIVATE_DIR = ".";
...
_PUBLIC_ const char *dyn_TORTUREDIR = ".";
